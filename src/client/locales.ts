...
export const zh = {
  ...
  "settings.secret.cover": "封面 · 火山方舟",
  "settings.secret.coverHint": "分析画面和生成封面。对应 ARK_API_KEY（火山方舟 · 豆包 Seedream），到火山方舟控制台申请。",
  ...
  "inspector.cover.needKey": "先到设置 → 插件 → 内容工作台 填写火山方舟 API Key",
...
export const en = {
  ...
  "settings.secret.cover": "Covers · Volcengine Ark",
  "settings.secret.coverHint": "Frame analysis and cover generation. Uses ARK_API_KEY (Volcengine Ark / Doubao Seedream); apply at the Volcengine Ark console.",
  ...
  "inspector.cover.needKey": "Add a Volcengine Ark API key in Settings → Plugins → Content workbench",
